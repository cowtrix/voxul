...
namespace Voxul.Utilities
{
    ...
    public abstract class VoxelCoordinateTree<T> where T : struct
	{
		...
		public VoxelCoordinateTree(sbyte maxLayer)
		{
			MinLayer = maxLayer;
			m_root = new Partition(new VoxelCoordinate { Layer = MinLayer });
		}

		public VoxelCoordinateTree(sbyte maxLayer, IDictionary<VoxelCoordinate, T> data) : this(maxLayer)
		{
