...
namespace Voxul.Utilities.RectanglePacker
{
    ...
    public struct PackingRectangle : IEquatable<PackingRectangle>, IComparable<PackingRectangle>
    {
        ...
        /// </summary>
        public PackingRectangle(Rect rectangle, int id = 0)
            : this((uint)rectangle.x, (uint)rectangle.y, (uint)rectangle.width, (uint)rectangle.height, id)
        {

        }

        public static implicit operator Rect(PackingRectangle rectangle)
            => new Rect((int)rectangle.X, (int)rectangle.Y, (int)rectangle.Width, (int)rectangle.Height);

        public static implicit operator PackingRectangle(Rect rectangle)
